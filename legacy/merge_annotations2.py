    ...
    def merge_single_image(self, image_name: str, image_annotations: Dict[str, Dict]) -> Optional[Dict]:
        ...
        for group in matched_groups:
            ...
            merged_shape = {
                ...
                'group_id': None,
                'description': f'merged from {len(selected_polygons)} annotations',
                'difficult': False,
                'shape_type': 'polygon',
                'flags': {},
                'attributes': {},
...
def main():
    ...
    """
    # 설정
    root_directory = '/Users/woojin/Documents/AioT/test/sample_images/Imgenet-ESM-SS/batch_1st/batch_1st_validation'  # annotator1, annotator2, annotator3이 있는 폴더
    iou_threshold = 0.5
    min_annotators = 2
